...
import (
	...
	worker3 "github.com/weitrue/Seckill/infrastructure/worker"
)
...
func (w *worker) Push(t worker3.Task) bool {
	if w.isClosed() {
		return false
	}
...
func (w *worker) process(t worker3.Task) {
	defer func() {
