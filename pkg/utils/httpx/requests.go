...
var (
	formUnmarshaler   = NewUnmarshaler(formKey, WithStringValues())
	pathUnmarshaler   = NewUnmarshaler(pathKey, WithStringValues())
	headerUnmarshaler = NewUnmarshaler(headerKey, WithStringValues())
)
...
func ParseJsonBody(r *http.Request, v interface{}) error {
	...
	return UnmarshalJsonReader(reader, v)
}
