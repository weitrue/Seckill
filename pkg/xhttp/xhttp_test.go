...
func TestParse(t *testing.T) {
	r, err := http.NewRequest(http.MethodPost, "http://172.16.101.87:46792/v2/chunk/upload", strings.NewReader(
		`{
...
type TestRequest struct {
	ID     int64             `json:"id,optional"`     // 请求id
	Method string            `json:"method,optional"` // 请求方法
	Params []json.RawMessage `json:"params,optional"` // 请求参数
}
